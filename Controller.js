...
class Controller{
    constructor(game){
        ...
        //Adiciona o joystick na tela do celular
 /*       if('ontouchstart' in document.documentElement){
    ...
    checkForGamepad(){
        ...
        function gamepadHandlerTwo(event, connecting) {
        ...
        window.addEventListener("gamepadconnected", function(e) { gamepadHandlerTwo(e, true); }, false);
        window.addEventListener("gamepaddisconnected", function(e) { gamepadHandlerTwo(e, false); }, false);
    }
/*
    ...
    update(dt=0.0167){   
        ...
        if (playerMoved){
            ...
            this.camera.position.lerp(this.tmpVec3, 0.7); //0.7
