...
class JoyStick{
	constructor(options){
		...
		const circle = document.getElementById('joySOne');
		//circle.style.cssText = "position:absolute; bottom:3%; width:80px; height:80px; background:rgba(126, 126, 126, 0.5); border:#444 solid medium; border-radius:50%; left:1%;";
		//const thumb = document.createElement("div");
		const thumb = document.getElementById('joySTwo');
